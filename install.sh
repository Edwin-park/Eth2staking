...
echo ""
echo "---------------------------------"
echo -e "  자동 설치 ver : ""\033[32m"22.11.21"\033[0m"""
echo ""
echo "  Mev 릴레이 주소변경 "
echo ""
echo "---------------------------------"
